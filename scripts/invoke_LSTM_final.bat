...
SET PYTHON_FE_SCRIPT_NAME=%SCRIPT_DIR%hyper_para_identify_test_pdf_gen_test4.py
...
REM SET PYTHON_FE_SCRIPT_NAME=soc_prediction_pipeline.py
...
REM SET OUTPUT_CSV_FILE=%INPUT_DATA_DIR%\FINAL_MASTER_DATASET_with_Features.csv
...
REM SET CMD_TO_RUN=%PYTHON_EXE% "%PYTHON_FE_SCRIPT%" "%INPUT_CSV_FILE%"
